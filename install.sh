...
cd ~
pm2 status
sudo env PATH=$PATH:`pwd`/.config/nvm/versions/node/v12.14.0/bin `pwd`/.config/nvm/versions/node/v12.14.0/lib/node_modules/pm2/bin/pm2 startup systemd -u $CURUSER --hp `pwd`
